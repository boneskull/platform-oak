...
env.Replace(
    ...
    FRAMEWORK_OAKCORE_DIR=platform.get_package_dir("framework-oakcore"),
    ...
    UPLOADER="esptool2",
    UPLOADEROTA=join(platform.get_package_dir("tool-oakcli") or "", "oak"),
    ...
    UPLOADOTACMD='$UPLOADEROTA $UPLOADEROTAFLAGS $SOURCE',
